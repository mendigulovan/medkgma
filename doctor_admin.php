  ...
  <span class="menu"><img src="images/menu-icon.png" alt=""/></span>
    <nav class="navbar navbar-default">
     <ul class="nav navbar-nav">
       ...
       <li class="active"><a href="doctor_admin.php">Специалисты</a></li>
  ...
  ================================================== -->
   ...
   <div id="content-wrap">
   	...
   	<div class="row">
        ...
        <button type="submit" /><a href="add_akcii.php"><h3>Добавить специалиста</h3></a></button>
	   		<article class="entry">
					<header class="entry-header">
            <div class="work-title humble-title">
            <h3>Специалисты</h3><br/>
          </div>
					</header>
            ...
            <div class="row">
               ...
               <div class="col-md-8">
                 ...
                 <img src="<?php echo $doctor['doctor_img']; ?> " height="200px"/>
               <menu>
                  <ul>
