...
$querySpecialization = 'select distinct name, id from categories';
...
if ($_SERVER ["REQUEST_METHOD"] == "POST") {
	...
	$get_docid = mysqli_fetch_array ( mysqli_query ( $conn, "Select doctor_id from doctor where email='$doc_email'" ) );
	...
	<?php require_once 'header.php'; ?>
			<div class="top-nav">
				...
				<ul class="nav1">
					...
					<li><a href="MakeAppointment.php" class="active">Записаться к врачу</a></li>
					...
					<div class="features-text tg-wrap">
						<form class="form-horizontal" action="MakeAppointment.php"
							...
							<table class='tg'
								...
								<tr>
									<td>Направление</td>
									<td><select name="categories" class="btn1" id="spec"
								...
								<tr>
									...
									<td><button type="submit" class="btn1" id="book" name="book"
											onclick="">Подтвердить запись</button></td>
								</tr>
							</table>
						</form>
					</div>
