...
$querydoctor = "SELECT doctor.doctorid, person.fname, person.lname, doctor.doctor_cat
 								FROM person INNER JOIN doctor on person.email=doctor.email WHERE person.role='doctor'";
...
$queryHist = "SELECT appointment.patientid, person.fname, person.lname, appointment.date, appointment.prescription,
 							appointment.appid FROM appointment inner join patient on appointment.patientid=patient.patientid
