   ...
   <header id="top">
   	...
   	<div class="row">
   		...
   		<div class="header-content twelve columns">
		      ...
		      <h1 id="logo-text"><a href="index.php" title="">MedCentr KGMA</a></h1>
	   ...
	   <nav id="nav-wrap">
        ...
        <ul id="nav" class="nav">
          ...
          <li><a href="about.php">О медцентре</a></li>
           ...
           <li><a href="page.html">Специалисты</a></li>
           <li><a href="page.html">Цены</a></li>
           <li><a href="page.html">Контакты</a></li>
           <li><a href="page.html">Акции</a></li>
           <li class="current">Админ</a></li>
      </ul>
	   	</div>
