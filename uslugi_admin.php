...
$uslugi = get_uslugi(null,$_GET['id']);
?>
<!DOCTYPE html>
  ...
  <span class="menu"><img src="images/menu-icon.png" alt=""/></span>
    <nav class="navbar navbar-default">
     <ul class="nav navbar-nav">
       ...
       <li  class="active"><a href="uslugi_admin.php">Услуги</a></li>
  ...
  ================================================== -->
   ...
   <div id="content-wrap">
   	...
   	<div class="row">
        ...
        <button type="submit" /><a href="add_akcii.php"><h3>Добавить услугу</h3></a></button>
	   		<article class="entry">
