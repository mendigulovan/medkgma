...
$querySpecialization = "select * from doctor inner join categories on doctor.doctor_cat=categories.id where doctorid = '$doctorId'";
$getSpecialization = mysqli_query ( $conn, $querySpecialization );
$g = mysqli_fetch_array ( $getSpecialization );
$drName =  $g ['doctor_name'] ;
$specialization = $g ['name'];
