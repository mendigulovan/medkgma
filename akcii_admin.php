  ...
  <span class="menu"><img src="images/menu-icon.png" alt=""/></span>
    <nav class="navbar navbar-default">
     <ul class="nav navbar-nav">
       ...
       <li class="active"><a href="akcii_admin.php">Акции</a></li>
  ...
  ================================================== -->
   ...
   <div id="content-wrap">
   	...
   	<div class="row">
        ...
        <button type="submit" /><a href="add_akcii.php"><h3>Добавить акцию</h3></a></button>
	   		<article class="entry">
					<header class="entry-header">
	    <?php
     foreach($akcii as $akciya){
     ...
     ?>
	     ...
	     <h2><?php echo $akciya['title']; ?></a></h2>
     <p>
       Текст
     </p>
     <div><?php echo nl2br($akciya['text']); ?></div>
     <img src="<?php echo $akciya['img']; ?>" height="200px"/>
     <menu>
        <ul>
